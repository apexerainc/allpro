					...
					{MainSliderData.map((props) => (
						<SwiperSlide key={props.id} className={`overflow-hidden`}>
							<div className={`${styles.mainslider__item} relative w-full`}>
								...
								{props.layout === 'type1' ? (
									<section className={`${styles.mainslider__content} obj__inner-center obj__put-in z-[2] type__animation`} aria-label="Hero section">
										<div className={`${styles.type1__limiter} relative`}>
											<h1 className={`${styles.type1__title} relative text-left`}>
												...
												<span className={`${styles.type1__title_text} relative`}>
													{props.title}
												</span>
											</h1>
								...
								{props.layout === 'type2' ? (
									<section className={`${styles.mainslider__content} obj__inner-center obj__put-in z-[2] type__animation`} aria-label="Hero section">
										<div className={styles.type2__limiter}>
											<h1 className={`${styles.type2__title}`}>
												{props.title}
											</h1>
											<hr aria-hidden="true" />
