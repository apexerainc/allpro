							...
							<div className="md:flex md:gap-[30px] lg:gap-[60px] no-resize-text">
								<div className="lg:basis-2/3 md:basis-7/12">
									<SectionTitle
										...
										dataTitle="Professional Restoration Services for Commercial Properties"
										dataMaxWidth="630px"
									/>
									...
									<p className={`${styles.indent__top2}`}>
										Whether you are a property manager, a real estate developer, or a commercial building owner, you know that disaster can strike at any time. When water damage, fire damage, or other disasters affect your commercial property, it can create significant disruption to your business operations. Our experienced restoration team can guide you through the entire restoration process effectively and efficiently, minimizing downtime and getting you back to business.
									</p>
									<h4 className="ttsubtitle ttsubtitle__top">Industries We Serve:</h4>
									<p>
									From hotels to schools, we serve all sizes and types of commercial locations. We have the necessary equipment, certifications, and training to provide top-quality restoration services wherever you need them, 24/7.
									</p>
									...
									<h4 className="ttsubtitle ttsubtitle__top">Extensive Experience in Commercial Restoration</h4>
									<p>
										Customers love us for our quality craftsmanship, our professionalism, and our dedication to restoring commercial properties to pre-loss condition. We take on all types of commercial restoration projects, including water damage, fire damage, mold remediation, and complete reconstruction. Our IICRC-certified technicians handle commercial restoration services such as:
									</p>
									<ListWithTitle
